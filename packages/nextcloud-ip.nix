...
in
{
  imports = [ ./collabora-online-ip.nix ];
  ...
  services.nextcloud = {
    ...
    extraApps = with config.services.nextcloud.package.packages.apps; {
      ...
      inherit previewgenerator memories notes
    ...
    settings = {
      ...
      trusted_domains = [ "nextcloud.${domain}" "${ip}" ];
      ...
      trashbin_retention_obligation = "auto, 30"; # Delete files after 30 days
